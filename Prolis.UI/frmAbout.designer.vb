...
Partial Class frmAbout
    ...
    Private Sub InitializeComponent()
        ...
        TableLayoutPanel.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 22.9798F))
        TableLayoutPanel.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 77.0202F))
        ...
        LogoPictureBox.Size = New Size(141, 485)
        ...
        TextBoxDescription.Location = New Point(161, 202)
        TextBoxDescription.Margin = New Padding(10, 6, 5, 6)
        TextBoxDescription.Multiline = True
        TextBoxDescription.Name = "TextBoxDescription"
        TextBoxDescription.ReadOnly = True
        TextBoxDescription.ScrollBars = ScrollBars.Both
        TextBoxDescription.Size = New Size(494, 236)
