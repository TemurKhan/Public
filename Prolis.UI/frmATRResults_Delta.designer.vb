...
Partial Class frmATRResults_Delta
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmATRResults_Delta))
        ...
        ToolStrip1.Size = New Size(1211, 34)
        ...
        dtpTo.Location = New Point(242, 111)
        ...
        dtpFrom.Location = New Point(20, 111)
        ...
        lblTo.Location = New Point(242, 78)
        lblTo.Margin = New Padding(5, 0, 5, 0)
        lblTo.Name = "lblTo"
        lblTo.Size = New Size(206, 28)
        lblTo.TabIndex = 39
        lblTo.Text = "To"
        ' 
        ' lblFrom
        ...
        btnLoad.Location = New Point(756, 81)
        btnLoad.Margin = New Padding(5, 6, 5, 6)
        btnLoad.Name = "btnLoad"
        btnLoad.Size = New Size(124, 69)
        btnLoad.TabIndex = 40
        ...
        lblPos.Location = New Point(156, 328)
        lblPos.Margin = New Padding(5, 0, 5, 0)
        lblPos.Name = "lblPos"
        lblPos.Size = New Size(442, 38)
        lblPos.TabIndex = 41
        ...
        btnFirst.Location = New Point(34, 322)
        btnFirst.Margin = New Padding(5, 6, 5, 6)
        btnFirst.Name = "btnFirst"
        btnFirst.Size = New Size(51, 56)
        ...
        btnPrevious.Location = New Point(95, 322)
        btnPrevious.Margin = New Padding(5, 6, 5, 6)
        btnPrevious.Name = "btnPrevious"
        btnPrevious.Size = New Size(51, 56)
        ...
        btnNext.Location = New Point(610, 322)
        btnNext.Margin = New Padding(5, 6, 5, 6)
        btnNext.Name = "btnNext"
        btnNext.Size = New Size(51, 56)
        btnNext.TabIndex = 44
        ...
        btnLast.Location = New Point(669, 322)
        btnLast.Margin = New Padding(5, 6, 5, 6)
        btnLast.Name = "btnLast"
        btnLast.Size = New Size(51, 56)
        btnLast.TabIndex = 45
        ...
        ' txtAccID
        ' 
        txtAccID.Location = New Point(20, 197)
        txtAccID.Margin = New Padding(5, 6, 5, 6)
        txtAccID.Name = "txtAccID"
        txtAccID.ReadOnly = True
        txtAccID.Size = New Size(155, 31)
        txtAccID.TabIndex = 47
        ' 
        ' txtAccDate
        ' 
        txtAccDate.Location = New Point(189, 197)
        ...
        ' Label4
        ' 
        Label4.Location = New Point(209, 164)
        ...
        ' Label6
        ' 
        Label6.Location = New Point(754, 164)
        ...
        ' txtRTF
        ' 
        txtRTF.Location = New Point(1121, 44)
        txtRTF.Margin = New Padding(5, 6, 5, 6)
        txtRTF.Name = "txtRTF"
        txtRTF.Size = New Size(20, 15)
        txtRTF.TabIndex = 55
        txtRTF.Text = ""
        ...
        ' txtComment
        ' 
        txtComment.Location = New Point(1154, 23)
        txtComment.Margin = New Padding(5, 6, 5, 6)
        txtComment.Name = "txtComment"
        txtComment.Size = New Size(20, 31)
        ...
        cmbDirector.Location = New Point(862, 1122)
        cmbDirector.Margin = New Padding(5, 6, 5, 6)
        cmbDirector.Name = "cmbDirector"
        cmbDirector.Size = New Size(314, 33)
        cmbDirector.TabIndex = 78
        ' 
        ' Label13
        ' 
        Label13.AutoSize = True
        Label13.Location = New Point(752, 1128)
        ...
        ' Label9
        ' 
        Label9.Location = New Point(20, 1072)
        ...
        ' txtNote
        ' 
        txtNote.Location = New Point(89, 1072)
        txtNote.Margin = New Padding(5, 6, 5, 6)
        txtNote.MaxLength = 960
        txtNote.Multiline = True
        txtNote.Name = "txtNote"
        txtNote.ScrollBars = ScrollBars.Vertical
        txtNote.Size = New Size(642, 85)
        txtNote.TabIndex = 75
        ' 
        ' Label8
        ' 
        Label8.AutoSize = True
        Label8.Location = New Point(754, 1083)
        ...
        Label7.Location = New Point(1032, 1081)
        ...
        ' txtRptTime
        ' 
        txtRptTime.Location = New Point(1092, 1075)
        ...
        dgvExceptions.Location = New Point(934, 73)
        ...
        dgvExceptions.Size = New Size(244, 233)
        ...
        chkRelease.Location = New Point(862, 322)
        chkRelease.Margin = New Padding(5, 6, 5, 6)
        chkRelease.Name = "chkRelease"
        chkRelease.Size = New Size(186, 53)
        ...
        ' lblExceptions
        ' 
        lblExceptions.Location = New Point(929, 38)
        lblExceptions.Margin = New Padding(5, 0, 5, 0)
        lblExceptions.Name = "lblExceptions"
        lblExceptions.Size = New Size(135, 28)
        ...
        Label16.Location = New Point(29, 242)
        ...
        ' txtMeds
        ' 
        txtMeds.Location = New Point(20, 272)
        txtMeds.Margin = New Padding(5, 6, 5, 6)
        txtMeds.Name = "txtMeds"
        txtMeds.ReadOnly = True
        txtMeds.Size = New Size(903, 31)
        txtMeds.TabIndex = 82
        ' 
        ' cmbWID
        ' 
        cmbWID.FormattingEnabled = True
        cmbWID.Location = New Point(469, 109)
        cmbWID.Margin = New Padding(5, 6, 5, 6)
        cmbWID.Name = "cmbWID"
        cmbWID.Size = New Size(250, 33)
        cmbWID.Sorted = True
        cmbWID.TabIndex = 84
        ' 
        ' Label1
        ' 
        Label1.Location = New Point(486, 75)
        ...
        dgvResults.Location = New Point(20, 391)
        ...
        dgvResults.Size = New Size(1149, 661)
        ...
        MaximizeBox = False
        MinimizeBox = False
        Name = "frmATRResults_Delta"
        ShowInTaskbar = False
        StartPosition = FormStartPosition.CenterParent
        Text = "∆ Delta-Results Requiring Attention"
